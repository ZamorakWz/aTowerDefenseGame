...
public class TowerCreationManager : MonoBehaviour
{
    ...
    public GameObject CreateTower(string towerType, Vector3 position)
    {
        ...
        AbstractBaseTower abstractTower = towerObject.GetComponent<AbstractBaseTower>();
    ...
    {
        List<AbstractBaseTower> abstractTowers = new List<AbstractBaseTower>();
        if (_greenTowerPrefab != null) { abstractTowers.Add(_greenTowerPrefab.GetComponent<AbstractBaseTower>()); }
        if (_blueTowerPrefab != null) { abstractTowers.Add(_blueTowerPrefab.GetComponent<AbstractBaseTower>()); }
        if (_redTowerPrefab != null) { abstractTowers.Add(_redTowerPrefab.GetComponent<AbstractBaseTower>()); }
        if (_whiteTowerPrefab != null) { abstractTowers.Add(_whiteTowerPrefab.GetComponent<AbstractBaseTower>()); }
